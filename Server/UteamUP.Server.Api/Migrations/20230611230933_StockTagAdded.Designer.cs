...
namespace UteamUP.Server.Api.Migrations
{
    ...
    [Migration("20230611230933_StockTagAdded")]
    partial class StockTagAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UteamUP.Shared.Models.StockTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StockId", "TagId")
                        .IsUnique();

                    b.ToTable("StockTags");
                });

            modelBuilder.Entity("UteamUP.Shared.Models.StockTools", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("QuantityMustHave")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UteamUP.Shared.Models.ToolTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UteamUP.Shared.Models.StockTools", b =>
                {
                    ...
                    b.HasOne("UteamUP.Shared.Models.Tool", "Tools")
                        .WithMany()
            ...
            modelBuilder.Entity("UteamUP.Shared.Models.ToolTag", b =>
                {
                    ...
                    b.HasOne("UteamUP.Shared.Models.Tool", "Tool")
                        .WithMany("ToolTags")
